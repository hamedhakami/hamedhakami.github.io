...
p.nominalBounds = new cjs.Rectangle(0,0,3300,1080);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1399,469,0.4191,0.4191);

	this.instance_1 = new lib.k3();
	this.instance_1.setTransform(1399,0,0.4191,0.4191);

	this.instance_2 = new lib.k2();
	this.instance_2.setTransform(0,469,0.4191,0.4191);

	this.instance_3 = new lib.k1();
	this.instance_3.setTransform(0,0,0.4191,0.4191);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1594.3,460.8,1,1,0,0,0,1391,460.8);
...
p.nominalBounds = new cjs.Rectangle(0,0,2985.3,921.6);


// stage content:
(lib._1v2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(2798,469,0.4191,0.4191);

	this.instance_2 = new lib.k5();
	this.instance_2.setTransform(2798,0,0.4191,0.4191);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]},24).to({state:[]},26).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]},20).to({state:[]},30).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11},{t:this.instance_10},{t:this.instance_9}]},16).to({state:[]},34).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_14},{t:this.instance_13},{t:this.instance_12}]},12).to({state:[]},38).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_17},{t:this.instance_16},{t:this.instance_15}]},8).to({state:[]},42).wait(1));
	...
	this.instance_19 = new lib.k6();
	this.instance_19.setTransform(2798,469,0.4191,0.4191);

	this.instance_20 = new lib.k5();
	this.instance_20.setTransform(2798,0,0.4191,0.4191);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18}]},4).to({state:[]},46).wait(1));
