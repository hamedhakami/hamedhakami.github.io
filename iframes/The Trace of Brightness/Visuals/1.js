...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("EBO9BUYMAAAiovMA+pAAAMAAACovg");
	mask.setTransform(906.225,540);

	// Slider_5
	this.instance = new lib.MovingImages("synched",0,false);
	this.instance.setTransform(1775.9,460.8,1,1,0,0,0,1391,460.8);
	...
	mask_1._off = true;
	mask_1.graphics.p("EA8KBUYMAAAiovMAyUAAAMAAACovg");
	mask_1.setTransform(707,540);

	// Slider_4
	this.instance_1 = new lib.MovingImages("synched",0,false);
	this.instance_1.setTransform(1775.9,460.8,1,1,0,0,0,1391,460.8);
	...
	mask_2._off = true;
	mask_2.graphics.p("EAjKBUYMAAAiovMAyUAAAMAAACovg");
	mask_2.setTransform(547,540);

	// Slider_3
	this.instance_2 = new lib.MovingImages("synched",0,false);
	this.instance_2.setTransform(1775.9,460.8,1,1,0,0,0,1391,460.8);
	...
	mask_3._off = true;
	mask_3.graphics.p("EAKKBUYMAAAiovMAyUAAAMAAACovg");
	mask_3.setTransform(387,540);

	// Slider_2
	this.instance_3 = new lib.MovingImages("synched",0,false);
	this.instance_3.setTransform(1775.9,460.8,1,1,0,0,0,1391,460.8);
	...
	mask_4._off = true;
	mask_4.graphics.p("EgO1BUYMAAAiovMAyTAAAMAAACovg");
	mask_4.setTransform(227,540);

	// Slider
	this.instance_4 = new lib.MovingImages("synched",0,false);
	this.instance_4.setTransform(1775.9,460.8,1,1,0,0,0,1391,460.8);
...
p.nominalBounds = new cjs.Rectangle(0,0,1812.5,540);
// library properties:
lib.properties = {
