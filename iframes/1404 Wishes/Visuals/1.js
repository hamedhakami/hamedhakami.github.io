...
(lib.Greencopymin = function() {
	this.initialize(img.Greencopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1350);


(lib.Purplecopymin = function() {
	this.initialize(img.Purplecopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1350);


(lib.Redcopymin = function() {
	this.initialize(img.Redcopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1350);


(lib.RoseGoldcopymin = function() {
	this.initialize(img.RoseGoldcopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1350);


(lib.Yellowcopymin = function() {
	this.initialize(img.Yellowcopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1350);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RoseGoldcopymin();
	this.instance.setTransform(2650,0,0.4859,0.4859);

	this.instance_1 = new lib.Yellowcopymin();
	this.instance_1.setTransform(2120,0,0.4859,0.4859);

	this.instance_2 = new lib.Purplecopymin();
	this.instance_2.setTransform(1590,0,0.4859,0.4859);

	this.instance_3 = new lib.Bluecopymin();
	this.instance_3.setTransform(1060,0,0.4859,0.4859);

	this.instance_4 = new lib.Redcopymin();
	this.instance_4.setTransform(530,0,0.4859,0.4859);

	this.instance_5 = new lib.Greencopymin();
	this.instance_5.setTransform(0,0,0.4859,0.4859);
...
p.nominalBounds = new cjs.Rectangle(0,0,3174.8,656);
...
p.nominalBounds = new cjs.Rectangle(0,0,3529.6,656);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("EgZNBUYMAAAiovMAybAAAMAAACovg");
...
p.nominalBounds = new cjs.Rectangle(0,0,3204.1,656);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Greencopymin.jpg", id:"Greencopymin"},
		{src:"images/Purplecopymin.jpg", id:"Purplecopymin"},
		{src:"images/Redcopymin.jpg", id:"Redcopymin"},
		{src:"images/RoseGoldcopymin.jpg", id:"RoseGoldcopymin"},
		{src:"images/Yellowcopymin.jpg", id:"Yellowcopymin"}
	],
	preloads: []
};
