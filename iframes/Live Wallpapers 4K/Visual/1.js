...
(lib.Screenshots01 = function() {
	this.initialize(img.Screenshots01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots02 = function() {
	this.initialize(img.Screenshots02);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots03 = function() {
	this.initialize(img.Screenshots03);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots04 = function() {
	this.initialize(img.Screenshots04);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots05 = function() {
	this.initialize(img.Screenshots05);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots06 = function() {
	this.initialize(img.Screenshots06);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots07 = function() {
	this.initialize(img.Screenshots07);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots08 = function() {
	this.initialize(img.Screenshots08);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots11 = function() {
	this.initialize(img.Screenshots11);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots12 = function() {
	this.initialize(img.Screenshots12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);


(lib.Screenshots13 = function() {
	this.initialize(img.Screenshots13);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,887,1920);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Screenshots13();
	this.instance.setTransform(3813,0,0.4166,0.4167);

	this.instance_1 = new lib.Screenshots12();
	this.instance_1.setTransform(3432,0,0.4166,0.4167);

	this.instance_2 = new lib.Screenshots11();
	this.instance_2.setTransform(3050,0,0.4166,0.4167);

	this.instance_3 = new lib.Screenshots08();
	this.instance_3.setTransform(2669,0,0.4166,0.4167);

	this.instance_4 = new lib.Screenshots07();
	this.instance_4.setTransform(2288,0,0.4166,0.4167);

	this.instance_5 = new lib.Screenshots06();
	this.instance_5.setTransform(1907,0,0.4166,0.4167);

	this.instance_6 = new lib.Screenshots05();
	this.instance_6.setTransform(1525,0,0.4166,0.4167);

	this.instance_7 = new lib.Screenshots04();
	this.instance_7.setTransform(1144,0,0.4166,0.4167);

	this.instance_8 = new lib.Screenshots03();
	this.instance_8.setTransform(763,0,0.4166,0.4167);

	this.instance_9 = new lib.Screenshots02();
	this.instance_9.setTransform(381,0,0.4166,0.4167);

	this.instance_10 = new lib.Screenshots01();
	this.instance_10.setTransform(0,0,0.4166,0.4166);
...
p.nominalBounds = new cjs.Rectangle(0,0,4182.5,800);
...
p.nominalBounds = new cjs.Rectangle(0,0,4537.3,800);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("Eg6CBUYMAAAiovMB0FAAAMAAACovg");
	mask.setTransform(4211.625,540);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Screenshots01.jpg", id:"Screenshots01"},
		{src:"images/Screenshots02.jpg", id:"Screenshots02"},
		{src:"images/Screenshots03.jpg", id:"Screenshots03"},
		{src:"images/Screenshots04.jpg", id:"Screenshots04"},
		{src:"images/Screenshots05.jpg", id:"Screenshots05"},
		{src:"images/Screenshots06.jpg", id:"Screenshots06"},
		{src:"images/Screenshots07.jpg", id:"Screenshots07"},
		{src:"images/Screenshots08.jpg", id:"Screenshots08"},
		{src:"images/Screenshots11.jpg", id:"Screenshots11"},
		{src:"images/Screenshots12.jpg", id:"Screenshots12"},
		{src:"images/Screenshots13.jpg", id:"Screenshots13"}
	],
	preloads: []
};
