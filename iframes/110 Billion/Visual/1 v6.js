...
(lib.Bluemin = function() {
	this.initialize(img.Bluemin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1432);


(lib.p01copymin = function() {
	this.initialize(img.p01copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1740,512);


(lib.p03copymin = function() {
	this.initialize(img.p03copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,590,720);


(lib.p04copymin = function() {
	this.initialize(img.p04copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1327,512);


(lib.thefirstframemin = function() {
	this.initialize(img.thefirstframemin);
}).prototype = p = new cjs.Bitmap();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.instance = new lib.p03copymin();
	this.instance.setTransform(2070,0,1.2912,1.2912);

	this.instance_1 = new lib.p04copymin();
	this.instance_1.setTransform(718,410);

	this.instance_2 = new lib.p01copymin();
	this.instance_2.setTransform(718,0,0.7626,0.7626);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_2
	this.instance_3 = new lib.Bluemin();
	this.instance_3.setTransform(0,0,0.6436,0.6436);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Layer_3
	this.instance_4 = new lib.thefirstframemin();
	this.instance_4.setTransform(2856,0,0.8537,0.8537);
...
p.nominalBounds = new cjs.Rectangle(0,0,3778,929.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,4132.8,929.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.an_Video({'id': '', 'src':'videos/Colors.webm', 'autoplay':true, 'controls':false, 'muted':true, 'loop':true, 'poster':'', 'preload':true, 'class':'video'});

	this.instance.setTransform(347.85,461.3,1.7384,3.0733,0,0,0,200.1,150.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(37).to({_off:false},0).wait(21));

	// Layer_1
	this.instance_1 = new lib.an_Video({'id': 'instance_1', 'src':'videos/Steps%2010fps%20for%20video.webm', 'autoplay':true, 'controls':false, 'muted':true, 'loop':true, 'poster':'', 'preload':true, 'class':'video'});

	this.instance_1.setTransform(3317.35,461,2.3049,3.0733,0,0,0,200,150);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bluemin.jpg", id:"Bluemin"},
		{src:"images/p01copymin.jpg", id:"p01copymin"},
		{src:"images/p03copymin.jpg", id:"p03copymin"},
		{src:"images/p04copymin.jpg", id:"p04copymin"},
		{src:"images/thefirstframemin.jpg", id:"thefirstframemin"},
