...
(lib.Clapperboardv2copymin = function() {
	this.initialize(img.Clapperboardv2copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1920,1080);


(lib.RemoteControlv6copymin = function() {
	this.initialize(img.RemoteControlv6copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1920,1080);


(lib.Walletv42copymin = function() {
	this.initialize(img.Walletv42copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1920,1080);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.RemoteControlv6copymin();
	this.instance.setTransform(3290,0,0.8532,0.8532);

	this.instance_1 = new lib.Clapperboardv2copymin();
	this.instance_1.setTransform(1645,0,0.8532,0.8532);

	this.instance_2 = new lib.Walletv42copymin();
...
p.nominalBounds = new cjs.Rectangle(0,0,4928.2,922);
...
p.nominalBounds = new cjs.Rectangle(0,0,5283,922);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Clapperboardv2copymin.jpg", id:"Clapperboardv2copymin"},
		{src:"images/RemoteControlv6copymin.jpg", id:"RemoteControlv6copymin"},
		{src:"images/Walletv42copymin.jpg", id:"Walletv42copymin"}
	],
	preloads: []
};
