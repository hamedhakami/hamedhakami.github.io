...
(lib.PresentationMockupcopy = function() {
	this.initialize(img.PresentationMockupcopy);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.PresentationMockupcopy();
	this.instance.setTransform(-210,0,0.853,0.853);
...
p.nominalBounds = new cjs.Rectangle(-210,0,1637.7,921.2);
...
p.nominalBounds = new cjs.Rectangle(-210,0,1952,921.2);
...
p.nominalBounds = new cjs.Rectangle(0,0,1938.9,921.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/PresentationMockupcopy.jpg", id:"PresentationMockupcopy"}
	],
	preloads: []
};
