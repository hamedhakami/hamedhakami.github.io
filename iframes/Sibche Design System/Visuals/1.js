...
(lib.Presentationmin = function() {
	this.initialize(img.Presentationmin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1920,1047);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Presentationmin();
	this.instance.setTransform(-210,0,0.8516,0.8516);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Presentationmin.jpg", id:"Presentationmin"}
	],
	preloads: []
};
