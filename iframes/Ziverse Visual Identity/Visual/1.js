...
(lib.iPhoneMockupmin = function() {
	this.initialize(img.iPhoneMockupmin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1490,1080);


(lib.landscape_mockup_1copymin = function() {
	this.initialize(img.landscape_mockup_1copymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,3000,2000);


(lib.Moodboard02min = function() {
	this.initialize(img.Moodboard02min);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1920,1080);


(lib.Moodboard03min = function() {
	this.initialize(img.Moodboard03min);
}).prototype = p = new cjs.Bitmap();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.iPhoneMockupmin();
	this.instance.setTransform(3998,-6,0.8597,0.8597);

	this.instance_1 = new lib.landscape_mockup_1copymin();
	this.instance_1.setTransform(2592,-6,0.4665,0.4642);

	this.instance_2 = new lib.Moodboard03min();
	this.instance_2.setTransform(1657,-7,0.8597,0.8597);

	this.instance_3 = new lib.Moodboard02min();
	this.instance_3.setTransform(0,-7,0.8597,0.8597);
...
p.nominalBounds = new cjs.Rectangle(0,-7,5278.9,929.5);
...
p.nominalBounds = new cjs.Rectangle(0,-7,5633.7,929.5);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("EgeZBUYMAAAiovMA8zAAAMAAACovg");
	mask.setTransform(7567.65,540);
	...
	mask_7._off = true;
	mask_7.graphics.p("EgbEBUYMAAAiovMA2JAAAMAAACovg");
	mask_7.setTransform(5046.5,540);
	...
	mask_9._off = true;
	mask_9.graphics.p("EgbLBUYMAAAiovMA2XAAAMAAACovg");
	mask_9.setTransform(4356.7,540);
	...
	mask_21._off = true;
	mask_21.graphics.p("EgZJBUYMAAAiovMAyTAAAMAAACovg");
	mask_21.setTransform(481,540);
...
p.nominalBounds = new cjs.Rectangle(0,0,5633.7,922.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/iPhoneMockupmin.jpg", id:"iPhoneMockupmin"},
		{src:"images/landscape_mockup_1copymin.jpg", id:"landscape_mockup_1copymin"},
		{src:"images/Moodboard02min.jpg", id:"Moodboard02min"},
		{src:"images/Moodboard03min.jpg", id:"Moodboard03min"}
	],
	preloads: []
};
