...
lib.ssMetadata = [
		{name:"300X300 _video__atlas_1", frames: [[0,0,1404,451],[0,1186,1301,449],[0,453,845,731]]},
		{name:"300X300 _video__atlas_2", frames: [[579,757,441,434],[0,757,577,577],[757,0,229,64],[0,0,755,755]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["300X300 _video__atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["300X300 _video__atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._300X300video = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300X300 _video__atlas_1.png", id:"300X300 _video__atlas_1"},
		{src:"images/300X300 _video__atlas_2.png", id:"300X300 _video__atlas_2"}
	],
	preloads: []
};
