    ...
    document.querySelectorAll('.js-buttons1, .js-buttons2, .js-buttons3, .js-buttons4').forEach(function(button) {
        button.addEventListener('click', function () {
            ...
            if (this.classList.contains('js-buttons1')) {
                ...
                featureDetail.innerHTML = '<div class="about-detail fade-in"> <div class="about-detail-wrapper"> <span class="main-text list">Visual Design <br> 3D Modeling <br> UI/UX Design <br> HTML Ad Design <br> Art Direction <br> Prototyping <br> Photo Manipulation <br> GIF Banner Design <br> Digital Marketing Proficiency</span> </div> </div> <div class="about-detail fade-in"> <div class="about-detail-wrapper"> <span class="main-text list" style="margin-top: 2vw;">Adobe Illustrator <br> Adobe Photoshop <br> Adobe InDesign <br> Adobe Animate <br> Adobe XD <br> Adobe Premiere Pro <br> Maxon Cinema 4D <br> Figma</span> </div> </div>';
            } else if (this.classList.contains('js-buttons4')) {
                featureDetail.innerHTML = '<div class="about-detail fade-in"> <p class="main-text" style="text-align: justify; letter-spacing: .0.8rem; margin-top: 0;">As a designer at different companies, I apply my creativity and expertise in photo manipulation and 3D modeling to designing innovative and engaging visual solutions for various projects.3 I have over seven years of experience in visual design, working at different companies, such as Sibche, Taaghche, IranCard (Ayandeh Bank), and Shatel.4 My educational background in Music whry and Composition from the University of Tehran and Graphic Design from EITTC University has enriched my artistic vision and enhanced my skills in combining sound and image. </p> <p class="main-text" style="text-align: justify;">I am passionate about creating impactful and memorable designs that communicate effectively and resonate with audiences. My core competencies include creativity, collaboration, communication, and problem-solving.5 I am always eager to learn new techniques and trends, and to challenge myself with diverse and complex assignments.</p></div>';
            }
        });
    });
});
