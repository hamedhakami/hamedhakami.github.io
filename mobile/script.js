    ...
    document.querySelectorAll('.js-buttons1, .js-buttons2, .js-buttons3, .js-buttons4').forEach(function(button) {
        button.addEventListener('click', function () {
            ...
            if (this.classList.contains('js-buttons1')) {
                featureDetail.innerHTML = '<div class="about-detail fade-in"> <p class="main-text"  style="letter-spacing: .0.5rem; margin-top: 0; margin-bottom:0;">As a designer at different companies, I apply my creativity and expertise in photo manipulation and 3D modeling to designing innovative and engaging visual solutions for various projects.  I have over seven years of experience in visual design, working at different companies, such as Sibche, Taaghche, IranCard (Ayandeh Bank), and Shatel.  My educational background in Music Theory and Composition from the University of Tehran and Graphic Design from EITTC University has enriched my artistic vision and enhanced my skills in combining sound and image. </p> <p class="main-text" style="margin-top:0;" >I am passionate about creating impactful and memorable designs that communicate effectively and resonate with audiences. My core competencies include creativity, collaboration, communication, and problem-solving.  I am always eager to learn new techniques and trends, and to challenge myself with diverse and complex assignments.</p></div>';
                ...
                featureDetail.innerHTML = '<div class="about-detail fade-in"> <div class="about-detail-wrapper"> <span class="main-text list">UNIVERSITY OF TEHRAN</span> <span class="main-text list">Master’s Degree</span> <span class="main-text list">Music Theory and Composition</span> <span class="main-text list">October 2015 - July 2019</span> </div> <div class="about-detail-wrapper"> <span class="main-text list">EITTC</span> <span class="main-text list">Bachelor’s Degree</span> <span class="main-text list">Graphic Design</span> <span class="main-text list">February 2011 - February 2015</span> </div> </div>';
            }
        });
    });
});
