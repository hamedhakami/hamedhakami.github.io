...
(lib.AboutIranCardv3presentationcopymin = function() {
	this.initialize(img.AboutIranCardv3presentationcopymin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1080,1080);


(lib.slider1mockupcopy = function() {
	this.initialize(img.slider1mockupcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1602,714);


(lib.slider2mockupcopy = function() {
	this.initialize(img.slider2mockupcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1602,714);


(lib.slider3mockupcopy = function() {
	this.initialize(img.slider3mockupcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1602,714);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.AboutIranCardv3presentationcopymin();
	this.instance.setTransform(4866,0,0.6611,0.6611);

	this.instance_1 = new lib.slider2mockupcopy();
	this.instance_1.setTransform(3244,0);

	this.instance_2 = new lib.slider3mockupcopy();
	this.instance_2.setTransform(1622,0);

	this.instance_3 = new lib.slider1mockupcopy();
...
p.nominalBounds = new cjs.Rectangle(0,0,5580,714);
...
p.nominalBounds = new cjs.Rectangle(0,0,5934.8,714);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("EgbBBUYMAAAiovMA2DAAAMAAACovg");
	mask.setTransform(5391.3,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).wait(28));

	// Mask_6_copy_copy_copy_copy_copy (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("EgbBBUYMAAAiovMA2DAAAMAAACovg");
	mask_1.setTransform(5046.75,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({_off:false},0).wait(32));

	// Mask_6_copy_copy_copy_copy (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	mask_2.graphics.p("EgbBBUYMAAAiovMA2DAAAMAAACovg");
	mask_2.setTransform(4702.175,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).wait(36));

	// Mask_6_copy_copy_copy (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	mask_3.graphics.p("EgbLBUYMAAAiovMA2XAAAMAAACovg");
	mask_3.setTransform(4357,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(8).to({_off:false},0).wait(40));

	// Mask_6_copy_copy (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	mask_4.graphics.p("Ega6BUYMAAAiovMA11AAAMAAACovg");
	mask_4.setTransform(4012.375,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).wait(44));

	// Mask_6_copy (mask)
	var mask_5 = new cjs.Shape();
	mask_5._off = true;
	mask_5.graphics.p("EgZJBUYMAAAiovMAyTAAAMAAACovg");
	mask_5.setTransform(3681,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({_off:false},0).wait(40));

	// Mask_5_copy (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	mask_6.graphics.p("EgZJBUYMAAAiovMAyTAAAMAAACovg");
	mask_6.setTransform(3361,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).wait(36));

	// Mask_4_copy (mask)
	var mask_7 = new cjs.Shape();
	mask_7._off = true;
	mask_7.graphics.p("EgZJBUYMAAAiovMAyTAAAMAAACovg");
	mask_7.setTransform(3041,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(16).to({_off:false},0).wait(32));

	// Mask_3_copy (mask)
	var mask_8 = new cjs.Shape();
	mask_8._off = true;
	mask_8.graphics.p("EgZJBUYMAAAiovMAyTAAAMAAACovg");
	mask_8.setTransform(2721,540);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(20).to({_off:false},0).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(24).to({_off:false},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(28).to({_off:false},0).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(24).to({_off:false},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(20).to({_off:false},0).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(16).to({_off:false},0).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(12).to({_off:false},0).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(8).to({_off:false},0).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(4).to({_off:false},0).wait(44));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,5564.3,714);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AboutIranCardv3presentationcopymin.jpg", id:"AboutIranCardv3presentationcopymin"},
		{src:"images/slider1mockupcopy.jpg", id:"slider1mockupcopy"},
		{src:"images/slider2mockupcopy.jpg", id:"slider2mockupcopy"},
		{src:"images/slider3mockupcopy.jpg", id:"slider3mockupcopy"}
	],
	preloads: []
};
